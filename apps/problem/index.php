<?php
  ...
  $fields = "*";
  $table = "problem";
  $problems = fetch_all($fields, $table);
?>
                ...
                <div class="row d-flex justify-content-center">
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" name="problem_name" id="problem_name" class="form-control form-control-sm" placeholder="Status Name *">
              ...
              <form action="apps/problem/do_problem.php?action=delete_all" id="frm" method="POST">
                ...
                $i = 1;
                  foreach($problems as $problem){
                    // if($problem["name"] == "In Progress"){
                    //   $bg = "warning";
                    // }elseif($problem["name"] == "Success"){
                    //   $bg = "success";
                    // }else{
                    //   $bg = "danger";
                    // }
                ?>
                      <tr>
                        ...
                        <!-- <td><span class="badge badge-<?php echo $bg;?> badge-pill"><?php echo $problem["name"];?></span></td> -->
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small><a class="dropdown-item problem-edit"
                                  href="javascript:void(0);" data-problem-id="<?php echo $problem["id"];?>" data-problem-name="<?php echo $problem["name"];?>"><i class="fas fa-edit"></i>
                                  Edit</a></small>
                              <small><a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                  data-target="#modalDelete" data-problem-id="<?php echo $problem["id"];?>" data-problem-name="<?php echo $problem["name"];?>"><i class="fas fa-trash"></i>
                                  Delete</a></small>
