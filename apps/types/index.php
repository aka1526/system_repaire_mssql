        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="border border-secondary p-3 mb-4 ">
              <form id="forminfo" action="apps/types/do_type.php?action=save_type" method="POST">
              ...
              <form action="apps/types/do_type.php?action=delete_all" id="frm" method="POST">
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small><a class="dropdown-item type-edit"
                                  href="javascript:void(0);" data-type-id="<?php echo $value["id"];?>" data-type-status="<?php echo $value["status"];?>" data-type-name="<?php echo $value["name"];?>" ><i class="fas fa-edit"></i>
                                  Edit</a></small>
