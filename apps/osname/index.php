...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Operating System</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
            ...
            <div class="border border-secondary p-3 mb-4 ">
              <form id="forminfo" action="apps/osname/do_osname.php?action=save_osname" method="POST">
                <div class="row d-flex justify-content-center">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" name="os_id" id="os_id" class="form-control form-control-sm" placeholder="Operating System Code *">
                       
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                       <input type="text" name="os_name" id="os_name" class="form-control form-control-sm" placeholder="Operating System Name *">
              ...
              <form action="apps/osname/do_osname.php?action=delete_all" id="frm" method="POST">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small>
                                <a class="dropdown-item os-edit"
                                  href="javascript:void(0);" 
                                    data-os-id="<?php echo $value["os_id"];?>" 
                                    data-os-name="<?php echo $value["os_name"];?>"
                                    data-os-stat="<?php echo $value["status"];?>" 
                                    >
                              ...
                              <small>
                                    ...
                                    data-os-id="<?php echo $value["os_id"];?>" 
                                    data-os-name="<?php echo $value["os_name"];?>"
                                    data-os-status="<?php echo $value["status"];?>"
                                    >
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="btn-group">
                      ...
                      <button type="button" class="btn-sm btn btn-danger btn-delete-all" 
